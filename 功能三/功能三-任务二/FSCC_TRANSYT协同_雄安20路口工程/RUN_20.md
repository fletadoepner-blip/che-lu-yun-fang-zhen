...
```powershell
docker run --rm -v "C:\Users\lauri\Desktop\雄安新区20路口_UGAT_FRAP_CityFlow:/workspace/final" --entrypoint /bin/bash xiong-an-20-platform:local -lc "cd /workspace/final && python src/run_cityflow.py --period morning --algorithm ugat_frap --steps 100 --threads 1"
```

## 7,500 步正式评测

```powershell
docker run --rm -v "C:\Users\lauri\Desktop\雄安新区20路口_UGAT_FRAP_CityFlow:/workspace/final" --entrypoint /bin/bash xiong-an-20-platform:local -lc "cd /workspace/final && python src/run_cityflow.py --period morning --algorithm ugat_frap --steps 7500 --threads 4"
```
...
```powershell
docker run --rm -v "C:\Users\lauri\Desktop\雄安新区20路口_UGAT_FRAP_CityFlow:/workspace/final" --entrypoint /bin/bash xiong-an-20-platform:local -lc "cd /workspace/final && python src/train_adapter.py --epochs 20"
```
